...
class PrefectMetrics:
    ...
    def __init__(self, url, headers, offset_minutes, polling_interval_seconds) -> None:
        """
    ...
    def get_deployments_metrics(self) -> None:
        ...
        """
        deployments = PrefectDeployments(self.url, self.headers)
    ...
    def get_flows_metrics(self) -> None:
        ...
        """
        flows = PrefectFlows(self.url, self.headers)
    ...
    def get_flow_runs_metrics(self) -> None:
        ...
        """
        flow_runs = PrefectFlowRuns(self.url, self.headers, self.offset_minutes)
    ...
    def get_work_pools_metrics(self) -> None:
        ...
        """
        work_pools = PrefectWorkPools(self.url, self.headers)
    ...
    def get_work_queues_metrics(self) -> None:
        ...
        """
        work_queues = PrefectWorkQueues(self.url, self.headers)
